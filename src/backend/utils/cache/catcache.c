...
SearchCatCache(CatCache *cache,
			   ...
			   Datum v4)
{
	return CdbGetTuple(SearchCatCacheInternal(cache, cache->cc_nkeys, v1, v2, v3, v4));
}
...
SearchCatCache1(CatCache *cache,
				Datum v1)
{
	return CdbGetTuple(SearchCatCacheInternal(cache, 1, v1, 0, 0, 0));
}
...
SearchCatCache2(CatCache *cache,
				Datum v1, Datum v2)
{
	return CdbGetTuple(SearchCatCacheInternal(cache, 2, v1, v2, 0, 0));
}
...
{
	return CdbGetTuple(SearchCatCacheInternal(cache, 3, v1, v2, v3, 0));
}
...
SearchCatCache4(CatCache *cache,
				Datum v1, Datum v2, Datum v3, Datum v4)
{
	return CdbGetTuple(SearchCatCacheInternal(cache, 4, v1, v2, v3, v4));
}
